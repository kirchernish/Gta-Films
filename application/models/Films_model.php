...
class Films_model extends CI_Model {
	...
	public function getFilmsNow($slug = FALSE, $limit) {
		...
		$query = $this->db->get_where('movie_now', array('slug' => $slug));
		return $query->row_array();
	}

	public function getFilmsRandom($slug = FALSE, $limit) {
